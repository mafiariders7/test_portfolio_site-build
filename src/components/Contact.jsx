...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    //templateId - template_ik3shz4, serviceId-service_ci5y69h, publickey- JN7qs3_1DgzpomyWZ
    emailjs.send(
      "service_ci5y69h",
      'template_ik3shz4',
      {
        ...
        to_email: "jucanteen03@gmail.com",
    ...
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      >
        ...
        >
          ...
          <button type="submit"
            className='bg-tertairy py-3 px-8 outine-none w-fit text-white font-bold
                         shadow-md shadow-primary rounnded-xl'
          >
            {
              loadiong ? "Sending..." : "Send"
            }
          </button>
        </form>
      </motion.div>
