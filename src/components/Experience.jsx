...
const ExperienceCaed = ({experience}) => (
   ...
   >
     <div>
       ...
       <p  className="text-white font-semibold text-[16px]" style ={{margin:0}}>{experience.company_name}</p>
     </div>
             ...
             <VerticalTimeline>
              {
                ...
                <ExperienceCaed experience={experience} key ={index} />
                ))
              }
             </VerticalTimeline>
      </div>
